...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/admin","/register", "/login","/Find/**","/api/**","/book/**","/journals/**").permitAll()
                ...
                .requestMatchers("/MyPage/**","/goal/**","/bookshelves/**","/reviews/**").hasAnyAuthority("ROLE_USER","ROLE_ADMIN")
