...
public class QAuthority extends EntityPathBase<Authority> {
    ...
    private static final long serialVersionUID = -1240062443L;
    ...
    public final io.github.chw3021.bookmakase.domain.QMember member;
    ...
    public QAuthority(Class<? extends Authority> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new io.github.chw3021.bookmakase.domain.QMember(forProperty("member")) : null;
    }
